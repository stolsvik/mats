...
/**
 * Testing Spring DB Transaction management, using DataSourceTransactionManager where the DataSource is wrapped only
 * for the TransactionManager - for the other users (JdbcTemplate etc), it is not wrapped.
 *
 * @author Endre Stølsvik 2020-06-05 00:10 - http://stolsvik.com/, endre@stolsvik.com
 */
@RunWith(SpringRunner.class)
public class Test_SpringManagedTx_H2Based_DataSourceTransactionaManager_Wrapped_OnlyTxMgr extends
        Test_SpringManagedTx_H2Based_AbstractResourceTransactionaManager {
    @Configuration
    @EnableMats
