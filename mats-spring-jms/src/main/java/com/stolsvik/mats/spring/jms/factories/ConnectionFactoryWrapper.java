...
public class ConnectionFactoryWrapper implements MatsWrapper<ConnectionFactory>, ConnectionFactory {
    ...
    /**
     * This field is private - if you in extensions need the instance, invoke {@link #unwrap()}. If
     ...
     *            the {@link ConnectionFactory} instance which {@link #unwrap()} will return (and
     ...
     * {@link #setWrappee(ConnectionFactory)} before publishing the instance (making it available for
     * other threads), or override {@link #unwrap()} to provide the desired
     ...
     * {@link #unwrap()} to provide for needed memory visibility semantics, i.e. establish a
     * happens-before edge between the setting of the instance and any other threads getting it.
     *
     * @param targetConnectionFactory
     *            the {@link ConnectionFactory} which is returned by {@link #unwrap()}, unless that
     *            is overridden.
     */
