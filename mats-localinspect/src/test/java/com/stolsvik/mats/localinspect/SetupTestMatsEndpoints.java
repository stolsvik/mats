...
public class SetupTestMatsEndpoints {
    ...
    static final String SERVICE = "LocalInterfaceTest.service";
    static final String TERMINATOR = "LocalInterfaceTest.terminator";

    public static void setupLeafService() {
        MatsEndpoint<DataTO, Void> single = getMatsFactory().single(SERVICE + ".Leaf", DataTO.class, DataTO.class,
                (context, dto) -> {
