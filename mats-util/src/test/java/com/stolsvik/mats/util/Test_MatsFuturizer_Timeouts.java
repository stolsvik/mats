 ...
 */
public class Test_MatsFuturizer_Timeouts extends MatsBasicTest {
    ...
    private void assertOneShotTimeoutByMatsFuturizer(
            MatsFuturizer futurizer) throws InterruptedException, TimeoutException {
