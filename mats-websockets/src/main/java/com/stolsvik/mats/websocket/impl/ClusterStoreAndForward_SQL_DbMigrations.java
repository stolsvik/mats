...
public class ClusterStoreAndForward_SQL_DbMigrations {
    ...
    /**
     * The classpath location of the migrations scripts, <b>note that you need two placeholders in these scripts</b>,
     * gotten by {@link #getPlaceHolders()}.
     */
    protected static String DB_MIGRATION_LOCATION = "/com/stolsvik/mats/websocket/impl/db_migrations";
    ...
    public void migrateUsingFlyway(DataSource dataSource) {
        ...
        Flyway.configure().dataSource(dataSource)
                ...
                .locations(getMigrationsLocation())
                .load()
                .migrate();
    }
}
